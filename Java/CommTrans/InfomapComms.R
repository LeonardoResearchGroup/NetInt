...
# Rscript --vanilla InfomapComms.R <EdgeListCSVfile> <OutputFilename> <EdgeWeigthOption> <NodeListCSVfile> 
...
tmp <- cluster_infomap(G, e.weights = edge.list[,edge.weight.option])
